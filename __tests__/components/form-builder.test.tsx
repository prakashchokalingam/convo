  ...
  FormCanvas: ({ config, onSelectField, onUpdateField, onRemoveField, onDuplicateField }: any) => (
    <div data-testid="form-canvas">
      ...
      {config.fields.map((field: any) => (
        <div key={field.id} data-testid={`field-${field.id}`} onClick={() => onSelectField(field.id)}>
          {field.label}
    ...
    <div data-testid="properties-panel">
      ...
      {selectedField && (
        <div data-testid="selected-field-properties">
          ...
          <button onClick={() => onUpdateField(selectedField.id, { label: 'Updated from Properties' })}>
            Update Field Label
          </button>
        </div>
      )}
...
describe('FormBuilder Component', () => {
  ...
  describe('Initial Rendering', () => {
    ...
    it('should render with initial configuration', () => {
      ...
      render(<FormBuilder initialConfig={initialConfig} onSave={mockOnSave} onPreview={mockOnPreview} />)
