              ...
              {workspaces.map((ws: AdminWorkspaceInfo) => (
                <TableRow key={ws.id}>
                  ...
                  <TableCell>
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded-full ${
                        ws.plan === 'Free' ? 'bg-gray-200 text-gray-700' :
                        ws.plan === 'pro' || ws.plan === 'Starter' || ws.plan === 'Professional' ? 'bg-blue-200 text-blue-700' :
                        ws.plan === 'Enterprise' ? 'bg-purple-200 text-purple-700' :
                  ...
                  <TableCell className="text-right">
                    {ws.createdAt ? format(new Date(ws.createdAt), "MMM d, yyyy 'at' h:mm a") : 'N/A'}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
