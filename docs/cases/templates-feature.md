...
- [ ] If the user has `create_template` permission in the _target workspace_, cloning succeeds.
- [ ] If the user lacks `create_template` permission in the _target workspace_, cloning is denied with a 403 error.
