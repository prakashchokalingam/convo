...
export function useVisibilityManager({
  ...
  }, [fieldValues, fields, dependencyManager, evaluationContext, onVisibilityChange, enableDebugMode])
  ...
  const getFieldEvaluationResult = useCallback((fieldId: string): EvaluationResult | undefined => {
