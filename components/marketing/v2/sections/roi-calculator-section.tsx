    ...
    <section className='py-20 lg:py-32'>
      <div className='max-w-7xl mx-auto px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          >
            See how much additional revenue you could generate by improving your form completion
            rates with Convo.
          </motion.p>
        </div>
        ...
        <div className='grid lg:grid-cols-2 gap-12 items-start'>
          ...
          >
            ...
            <div className='space-y-8'>
              {/* Monthly Forms */}
              <div>
                <label htmlFor='monthly-forms' className='block text-sm font-medium mb-3'>Monthly Form Submissions</label>
                <div className='px-4'>
                  <Slider
                    id='monthly-forms'
                    value={monthlyForms}
              ...
              <div>
                <label htmlFor='current-completion' className='block text-sm font-medium mb-3'>
                  Current Completion Rate (%)
                </label>
                <div className='px-4'>
                  <Slider
              ...
              {/* Value Per Response */}
              <div>
                <label htmlFor='value-per-response' className='block text-sm font-medium mb-3'>
                  Value per Form Response ($)
                </label>
                <div className='px-4'>
                  <Slider
                    id='value-per-response'
            ...
            <div className='bg-card border rounded-2xl p-8 shadow-lg'>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex justify-between items-center p-4 bg-muted rounded-xl'>
                  ...
                  <span className='text-xl font-bold'>{formatCurrency(588)}</span>
                </div>
