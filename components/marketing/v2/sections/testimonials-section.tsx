...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      "Our job application completion rate went from 23% to 78% after switching to conversational forms. Candidates love the personal touch, and we're getting much better quality applications.",
    results: {
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "We've tripled our lead quality since using Convo. The conversational approach gives us much richer customer data, and our sales team loves the qualified leads they're getting.",
    results: {
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "Patients appreciate the human touch in our intake forms. It's reduced waiting room time by 40% and improved our care quality significantly. The patient satisfaction scores speak for themselves.",
    results: {
  ...
  },
  {
    ...
    rating: 5,
    quote:
      'Convo has streamlined our entire onboarding process. New employees complete forms 3x faster than before, and our HR team can focus on what matters most - building relationships.',
    results: {
  ...
  },
  {
    ...
    rating: 5,
    quote:
      'Our customers now provide much more detailed feedback through our review forms. The insights have helped us improve our products and customer experience dramatically.',
    results: {
    ...
    <section className='py-20 lg:py-32 bg-muted/30'>
      <div className='max-w-7xl mx-auto px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          >
            See how organizations across industries are transforming their form experiences and
            achieving remarkable results with Convo.
          </motion.p>
        </div>
                      ...
                      <div className='absolute bottom-4 left-4 right-4'>
                        <div className='bg-black/50 backdrop-blur-sm rounded-lg p-3 text-white'>
                          <div className='font-medium'>
                            {current.name} shares their success story
                          </div>
