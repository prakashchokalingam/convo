...
const features = [
  {
    ...
    description:
      'Describe your form in natural language and watch our AI build it instantly with smart field types, validation rules, and optimized flow.',
    icon: Sparkles,
  ...
  },
  {
    ...
    description:
      'Transform any form into a natural conversation that feels human. Guide users through one question at a time for maximum engagement.',
    icon: MessageSquare,
    ...
    demo: {
      ...
      messages: [
        ...
        {
          type: 'bot',
          text: 'Great to meet you, Sarah! How many years of experience do you have?',
        },
      ],
    },
  ...
  },
  {
    ...
    description:
      'Get AI-powered analytics that reveal user behavior patterns, completion bottlenecks, and optimization opportunities.',
    icon: BarChart3,
  ...
  },
  {
    ...
    title: 'Smart Routing',
    description:
      'AI automatically creates conditional logic and branching based on user responses, creating personalized form experiences.',
    icon: Brain,
    ...
    <section id='features' className='py-20 lg:py-32'>
      <div className='max-w-7xl mx-auto px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          >
            Every feature is designed to maximize user engagement and form completion rates. See how
            AI transforms the entire form experience.
          </motion.p>
        </div>
              ...
              return (
                ...
                >
                  <div className='flex items-start gap-4'>
                    <div
                      className={`p-3 rounded-lg bg-gradient-to-br ${feature.color} text-white flex-shrink-0`}
                    >
                    ...
                    {features.map((_, index) => (
                      <div
                        ...
                        className={`h-1 rounded-full transition-all duration-300 ${
                          index === activeFeature ? 'bg-primary w-8' : 'bg-muted w-2'
                        }`}
                      />
                    ))}
                  </div>
