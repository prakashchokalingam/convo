...
const features = [
  {
    ...
    description: "Describe your form in plain English and watch our AI build it instantly with smart field types, validation rules, and conditional logic.",
    icon: Sparkles,
  ...
  },
  {
    ...
    description: "Transform any form into a natural conversation that feels like chatting with a human. Boost engagement and completion rates dramatically.",
    icon: MessageSquare,
    ...
    demo: {
      ...
      content: [
        ...
        { type: "bot", message: "Nice to meet you, Sarah! How would you rate your experience today?" },
        { type: "user", message: "⭐⭐⭐⭐⭐" },
  ...
  },
  {
    ...
    description: "Get AI-powered insights that help you understand responses, identify patterns, and optimize your forms for better conversion.",
    icon: BarChart3,
  ...
  },
  {
    ...
    description: "Forms load instantly and work seamlessly across all devices. Built for speed with global CDN and optimized performance.",
    icon: Zap,
