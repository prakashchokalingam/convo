      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-gray-600 mb-8 max-w-3xl mx-auto'>
            Increase form completion rates by 40-60% with AI-powered conversational forms. Transform
            boring surveys into engaging conversations.
          </p>
          ...
          <div className='grid md:grid-cols-4 gap-8'>
            ...
            <div>
              ...
              <div className='space-y-2'>
                <a href='/features' className='block text-gray-400 hover:text-white'>
                  Features
                </a>
                <a href='/pricing' className='block text-gray-400 hover:text-white'>
                  Pricing
                </a>
                <a href='/docs' className='block text-gray-400 hover:text-white'>
                  Templates
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className='space-y-2'>
                ...
                <a href='/blog' className='block text-gray-400 hover:text-white'>
                  Blog
                </a>
            ...
            <div>
              ...
              <div className='space-y-2'>
                <a href='/help' className='block text-gray-400 hover:text-white'>
                  Help Center
                </a>
                <a href='/docs' className='block text-gray-400 hover:text-white'>
                  Documentation
                </a>
                <a href='/api-docs' className='block text-gray-400 hover:text-white'>
                  API Reference
                </a>
              </div>
            </div>
