    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Select a template to start building your form, or browse our collection
            of pre-made templates for different business needs.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="flex items-center justify-between">
                ...
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => {/* Could open preview modal */}}
                >
