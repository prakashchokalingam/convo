    ...
    >
      <div className='max-w-md mx-auto'>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
          <h3 className='text-xl font-semibold text-foreground mb-2'>Start Building Your Form</h3>
          <p className='text-muted-foreground mb-6'>
            Drag fields from the library on the left to begin creating your form. You can reorder,
            customize, and configure each field as needed.
          </p>
        </motion.div>
        ...
        >
          <div className='flex items-start space-x-3 text-left'>
            ...
            <div>
              ...
              <p className='text-xs text-muted-foreground'>
                Browse the field library and select what you need
              </p>
            </div>
          </div>
          ...
          <div className='flex items-start space-x-3 text-left'>
            ...
            <div>
              ...
              <p className='text-xs text-muted-foreground'>
                Use the properties panel to set labels, validations, and more
              </p>
            </div>
          </div>
        </motion.div>
