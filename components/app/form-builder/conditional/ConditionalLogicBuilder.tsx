...
import { ConditionalLogic, FieldConfig } from '@/lib/form-builder/types';
...
export function ConditionalLogicBuilder({
  ...
  const handleUpdateCondition = useCallback(
    (index: number, updatedCondition: ConditionalLogic['conditions'][0]) => {
  ...
  const hasValidConditions = conditional.conditions.every(
    c => c.fieldId && c.operator && c.value !== undefined && c.value !== ''
  );
      ...
      <Card className={className}>
        ...
        <CardContent>
          <p className='text-sm text-gray-600'>
            No fields available for conditional logic. Add fields above this one to enable
                    ...
                    {index < conditional.conditions.length - 1 && (
                      <div className='flex justify-center'>
                        <Select
                          ...
                          onValueChange={logic =>
                            handleUpdateConditional({ logic: logic as 'and' | 'or' })
                          }
                        >
