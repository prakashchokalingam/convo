...
export const DashboardStats = memo(({ workspaceId }: { workspaceId: string }) => {
  const stats = [
    {
      title: 'Total Forms',
      value: 0,
      ...
      <CardContent className="p-0">
        {recentForms.length === 0 ? (
          <div className="text-center py-12 px-6">
            <div className="mx-auto w-12 h-12 bg-muted rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href={getFormsUrl(workspaceId, '/new')}>
                Create Form
              </Link>
            </Button>
          </div>
